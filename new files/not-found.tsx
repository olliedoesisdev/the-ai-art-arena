  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        {/* Big 404 */}
        <p className="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-purple-400 to-purple-800 select-none mb-6">
          404
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="px-6 py-2.5 rounded-xl text-sm font-semibold bg-purple-600 hover:bg-purple-500 text-white transition-colors"
          >
            This Week&apos;s Contest
          </Link>
          <Link
            href="/archive"
            className="px-6 py-2.5 rounded-xl text-sm font-semibold bg-gray-800 hover:bg-gray-700 text-gray-300 transition-colors"
          >
            Browse Archive
          </Link>
        </div>
